...
state/               runtime records and signals; gitignored
  ...
  <id>.state-marker  epoch second of the last pipeline-state read for this task and the sidebar marker then shown; bin/fm-state-marker.sh owns its cadence and clearing, and teardown removes it
