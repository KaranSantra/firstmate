...
test_spawn_secondmate_harness_model_token() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --dangerously-skip-permissions --settings '{\"feedbackDrafts\":\"off\",\"attribution\":{\"commit\":\"\",\"pr\":\"\",\"sessionUrl\":false}}' --no-chrome --model 'opus'" \
...
test_spawn_secondmate_harness_model_and_effort_tokens() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --dangerously-skip-permissions --settings '{\"feedbackDrafts\":\"off\",\"attribution\":{\"commit\":\"\",\"pr\":\"\",\"sessionUrl\":false}}' --no-chrome --model 'opus' --effort 'high'" \
...
test_spawn_secondmate_claude_permission_mode_auto() {
  ...
  launch=$(cat "$launchlog")
  assert_contains "$launch" "claude --permission-mode auto --settings '{\"feedbackDrafts\":\"off\",\"attribution\":{\"commit\":\"\",\"pr\":\"\",\"sessionUrl\":false}}' --no-chrome --model 'opus'" \
